...
- [ ] **New Features (`index.html` & `script.js`)**:
...
## 4. 🛠️ Code Robustness
- [ ] **Error Handling**: Ensure graceful failure if stock data fetching fails.
- [ ] **Feedback**: Visual cues for "Thinking..." states.
- [ ] **Turn Limits**: Hard cap the number of turns for the Verifier Agent (and others) to prevent infinite loops/excessive costs.
